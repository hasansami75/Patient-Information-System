...
<!--                    </form>-->
                ...
                <li><a href="assistant_update.php">Profile</a></li>

                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        <?php
                            if(isset($_SESSION['id'])){
                                $query = "SELECT * FROM assistant WHERE id = {$_SESSION['id']}";
                    ...
                    <ul class="dropdown-menu">
                        <li class="text-center"><a href="assistant_update.php">Profile</a></li>
